  ...
  if (deep.zona || deep.zona_convergida) {
    ...
    if (!deep.integridade_analise?.valuation_zone_suppressed && list(deep.integridade_analise?.convergence_excluded_layers).length) {
      writer.card(
        ...
        `Camadas incluídas: ${list(deep.integridade_analise.convergence_included_layers).join(", ")}. Camadas fora da faixa central: ${list(deep.integridade_analise.convergence_excluded_layers).join(", ")}.`,
