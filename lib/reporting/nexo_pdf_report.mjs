...
import { evidenceDisplayLabel } from "../ui/evidence_labels.mjs";
  ...
  if (layers.length) {
    ...
    if (deep.integridade_analise?.valuation_zone_suppressed) {
      ...
      writer.card(
        ...
        "Menos de duas camadas apresentaram valores utilizáveis. A análise qualitativa permanece válida, mas a margem de segurança depende de uma memória de cálculo mais completa.",
