  ...
  if (layers.length) {
    ...
    if (deep.integridade_analise?.valuation_zone_suppressed) {
      ...
      writer.card(
        ...
        "Uma ou mais camadas apresentaram valor incompatível com a própria fórmula ou entradas insuficientes para validá-la. O servidor preservou ou corrigiu somente os cálculos verificáveis; a zona não foi reconstruída automaticamente.",
