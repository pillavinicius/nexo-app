...
function normalizeAdjustments(adjustments, sourcePhase, dimensions) {
  const seen = new Set();
  const normalized = [];
...
export function reconcileDeepIntegrity(result, history = {}) {
  ...
  const adjustments = normalizeAdjustments(source.ajustes_score, sourcePhase, dimensions);
