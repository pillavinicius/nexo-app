...
export const RECLASSIFICATION_INTEGRITY_VERSION = "P3B_v1.6";
...
export function reconcileDeepIntegrity(result, history = {}, { documentIds = [], referencePrice = null } = {}) {
  ...
  return {
    ...
    tese_final: reconcileThesisLayerPrices(source.tese_final, valuation.layers),
    zona: governedZone,
    zona_calc: {
      ...(source.zona_calc || {}),
...
export function buildDeterministicFinal({ ticker, history = {} }) {
  ...
  return {
    ...
    riscos_incorporados: [],
    ajustes_score: [],
    tese_final: reconcileThesisLayerPrices(
