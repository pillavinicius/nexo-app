...
const SHARED_CUSTOM_EVIDENCE = Object.freeze({
  id: "custom",
  label: "Outra evidência verificável (avançado)",
  statement: "",
});
...
export const EDGE_EVIDENCE_TEMPLATES = Object.freeze({
  ...
  estrutural: Object.freeze([
    ...
    },
    {
      ...
      label: "Restrição de mandato cria a distorção",
      statement:
        "uma restrição objetiva de mandato cria a distorção observada",
    },
    {
      id: "perimeter_restriction",
      label: "Perímetro institucional cria a distorção",
      statement:
...
export const EDGE_EVIDENCE_BASES = Object.freeze([
  { id: "module_output", label: "Resultado versionado do módulo", phrase: "resultado versionado do módulo" },
  { id: "official_statement", label: "Demonstração ou resultado oficial", phrase: "demonstração ou resultado oficial" },
  ...
  { id: "official_document", label: "Documento oficial ou regulatório", phrase: "documento oficial ou regulatório" },
...
export const EDGE_EXPIRY_TEMPLATES = Object.freeze([
  { id: "metric_below", label: "Métrica cruza um limite para baixo" },
  { id: "metric_above", label: "Métrica cruza um limite para cima" },
  { id: "objective_event", label: "Evento objetivo ocorre" },
  { id: "deadline_unconfirmed", label: "Prazo vence sem confirmação" },
  { id: "custom", label: "Outra condição observável (avançado)" },
]);
...
export const EDGE_EXPIRY_EVENTS = Object.freeze([
  { id: "contract_cancelled", label: "Contrato material cancelado ou rescindido", condition: "Quando o contrato material for cancelado ou rescindido." },
  ...
  { id: "guidance_withdrawn", label: "Guidance material retirado", condition: "Quando o guidance material for retirado oficialmente." },
  { id: "rating_downgrade", label: "Rating rebaixado", condition: "Quando o rating for rebaixado pela agência responsável." },
  { id: "regulation_revoked", label: "Regulação determinante revogada", condition: "Quando a regulação determinante for revogada." },
  { id: "forced_seller_ends", label: "Vendedor forçado deixa de atuar", condition: "Quando o vendedor forçado deixar de atuar no mercado." },
  { id: "perimeter_changed", label: "Perímetro institucional alterado", condition: "Quando o perímetro institucional ou contratual for alterado oficialmente." },
]);
