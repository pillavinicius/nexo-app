...
export const EDGE_INSUMO_METADATA = Object.freeze({
  ...
  HDL: {
    description:
      "Compara a TIR real esperada com a curva soberana ANBIMA no mesmo horizonte. O cálculo é determinístico e não altera o veredito por conta própria.",
    available: true,
  },
  NFI: {
    description:
      "Mede o fluxo estrangeiro oficial B3 e sua posição histórica para explicar deslocamentos de preço. Não altera valuation, score ou veredito.",
    available: true,
  },
  TDN: {
    description:
      "Testa empiricamente a proteção inflacionária nas janelas fixas 2015–2016 e 2021–2022. Só pode lastrear Edge quando as duas janelas estiverem completas.",
    available: true,
  },
  BJR: {
    description:
