...
const fixture = {
  ...
  final: {
    ticker: "TEST3",
    classificacao_final: "WATCHLIST",
    score_original: 24,
    score_revisado: 23,
    score_max: 30,
    mudanca_veredito: "MANTEVE",
    veredito_anterior: "APROVADO",
    veredito_reclassificado: "WATCHLIST",
    riscos_incorporados: [{ descricao: "Risco de execução", impacto_score: "-1", severidade: "MÉDIO" }],
    ajustes_score: [{ dimensao: "Execução", antes: 4, depois: 3, motivo: "Risco ainda não resolvido." }],
    tese_final: "A qualidade permanece, mas a relação entre preço, cenário e risco exige acompanhamento.",
    preco_final: { zona_convergencia: "R$ 39,00 a R$ 43,00", besst: "R$ 36,50", margem_seguranca: "15%", observacao: "Faixa de referência, não decisão automática." },
